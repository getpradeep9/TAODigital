package com.taodigital.service;


import com.taodigital.entity.ApprovalQueueEntity;
import com.taodigital.entity.ProductEntity;
import com.taodigital.repository.ApprovalQueueRepository;
import com.taodigital.repository.ProductRepository;
import com.taodigital.util.ProductDTO;
import com.taodigital.util.ProductStatus;
...
public class ProductService {
    ...
    public List<ApprovalQueueEntity> getAllProductFromApprovalQueue() {
        return approvalQueueRepository.findAll()
                .stream().sorted(Comparator.comparing(ApprovalQueueEntity::getApprovalQueueId).reversed()).collect(Collectors.toList());
    }
